  ...
  describe('#validateField', () => {
    ...
    describe('subfields', () => {
      ...
      describe('subfieldValues', () => {
        ...
        it('Should consider the field valid (control characters in subfieldValue), noControlCharacters: false', () => {
          const field = {'tag': 'CAT', 'ind1': ' ', 'ind2': ' ', 'subfields': [{'code': 'c', 'value': `2015\n0121\t124`}]};

          // eslint-disable-next-line no-unused-expressions
          expect(Utils.validateField(field, {noControlCharacters: false})).not.to.throw;
